...
export class ListWithContext extends Component {
  ...
  next = () => {
    this.setState({more: true, filters: {...this.state.filters, offset: this.state.filters.offset + 1}});
  };
                    ...
                    <div className="movies">
                      {this.props.movies.movies.map((movie) => (
                        <MovieCard
                          key={movie._id}
                          movie={movie}
                          onChange={movie => this.props.movies.update(movie._id, movie)}
                          onDelete={_ => this.props.movies.update(movie._id, undefined)}
